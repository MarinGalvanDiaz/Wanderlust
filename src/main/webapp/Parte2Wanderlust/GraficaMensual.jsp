        ...
        <div class="container-fluid">
            ...
            <br>
                ...
                <%
                    ...
                    ResultSet rs2 = null;
                    ResultSet rs3 = null;
                    String sql1 = "select * from rendimiento where Id_cliente = (?) and tipo='ingresomes';";
                    String sql21 = "select count(mes) from rendimiento where Id_cliente =(?) and tipo='ingresomes';";
                    String sql3 = "select * from rendimiento where Id_cliente = (?) and tipo='gastomes';";
