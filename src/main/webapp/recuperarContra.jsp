  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="registro.jsp">Regístrate</a>
        </li>
        ...
        <h4 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Ingrese su usuario</h4>
        <br><br><br>
        <form action="" method="post" name="formu">
            <div class="form-outline mb-4 col-4 mx-auto">
            <input type="text" name="usuario" placeholder="Usuario" id="form2Example18" class="form-control form-control-lg">
            <label class="form-label" for="form2Example18"></label>
            </div>
            <div class="d-grid gap-2 col-4 mx-auto">
            <button type="submit" name="subir" value="Recuperar" class="btn btn-info btn-lg btn-block">Recuperar</button> 
            </div>
        </form>
        </center>
            </div>
        ...
        <%if (request.getParameter("subir") != null) {
                ...
                String message = "Su contraseña es: " + contra;
              ...
              System.out.println("<script>alert('Contraseña enviada al correo electrónico proporcionado');</script>");
          request.getRequestDispatcher("/login2.jsp").forward(request, response);
          
    }
        
    else{
 System.out.println("<script>alert('Usuario no registrado');</script>");
