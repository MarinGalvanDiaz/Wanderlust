  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="registro_1.jsp">Regístrate</a>
        </li>
        </li>
        <li class="nav-item">
    ...
    <div class="row">
      ...
      <div class="col-sm-6 text-black center-block mx-auto align-items-center">
        ...
        <div class="container-fluid">
          ...
          <form style="width: 23rem;" action="srvUsuario?accion=verificar" id="formu" method="post" class="formu">
              <br>
              <br>
            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Log in</h3>

            <div class="form-outline mb-4">
                <input type="text" id="form2Example18" class="form-control form-control-lg" placeholder="Usuario" name="txtusu"/>
              <label class="form-label" for="form2Example18"></label>
            </div>

            <div class="form-outline mb-4">
                <input type="password" id="contra" class="form-control form-control-lg" placeholder="Password" name="txtcontra"/>
            ...
            <p>Deseas crear una cuenta? <a href="registro_1.jsp" class="link-info">Registrate</a></p>
            <a href="#">${msje}</a>
          </form>
