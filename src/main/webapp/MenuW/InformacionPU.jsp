...
<html lang="en">
    ...
    <body>
        <input type="hidden" value="${usuario.bytes}" name="foto">
        <%
            conexion conection = new conexion();
            Connection cn = null;
            Object objeto = session.getAttribute("usuario");
            usuario miObjeto = (usuario) objeto;
            int idusu = miObjeto.getId();
            System.out.println("Tu usuario es el numero " + idusu);
            String foto = null;
            ...
            if(rs.next()){
            byte[] imagenBytes = rs.getBytes(1);
